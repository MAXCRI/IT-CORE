...
const ItemCount = ({ stock, id, price, nombre }) => {
  ...
  const addToCart = () => {
    setCart((currItems) => {
      ...
      if (isItemFound) {
        ...
        return [...currItems, { id, quantity: count, price, nombre }];
      }
    });
  };
  ...
  return (
    <>
      <ButtonGroup size="sm" isAttached variant="outline">
        {count < 1 ? (
          <Tooltip label="Se agoto el stock" placement="bottom">
        ...
        {count < stock ? (
          ...
          <Tooltip label="supero el stock" placement="bottom">
